...
angular.module("learnJS").controller("listaTelefonicaFisicoCtrl", function ($scope, contatosFisicoAPI, operadorasAPI) {
    $scope.app = "Lista Telefônica";
    $scope.contatos = [];
    $scope.operadoras = [];

    var carregarContatos = function () {
        contatosFisicoAPI.getContatos().then(function (response) {
    ...
    $scope.delContatos = function (contatos) {
        ...
        contatosFisicoAPI.delContatos(idContatos).then(function (response) {
